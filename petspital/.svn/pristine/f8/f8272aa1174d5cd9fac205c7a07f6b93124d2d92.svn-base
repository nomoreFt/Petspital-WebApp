            ...
            <table class=table>
               <tr>
                  <td><input type="text" name="user_id" id="user_id"
                     placeholder="아이디" required class="form-control"></td>

               </tr>
               <tr>
                  <td><input type="text" name="user_name" id="user_name"
                     placeholder="이름" required class="form-control"></td>
               </tr>
               <tr>
                  <td><input type="text" name="user_phone" id="user_phone"
                     placeholder="핸드폰번호 ('-'를 포.함.한 번호를 입력해주세요)" required
                     class="form-control"></td>
               </tr>
               <tr>
                  <td rowspan="3"><input id="btn" type="submit" value="확인" class="btn btn-default pull-right">
                  </td>
               </tr>
            </table>
         </div>
