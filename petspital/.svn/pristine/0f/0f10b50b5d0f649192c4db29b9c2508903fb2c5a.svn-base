					                  ...
					                  success : function(data) {
					                     if (data == 1) {
					                        ...
					                        alert("회원가입이 완료!\n쿠폰이 발급되었습니다. 마이페이지에서 확인하세요:)");
					                       	location.href='${cp}/member/memberlogin';
					                       	
					                     } else if (data == 0) {
					                     	alert("회원가입 실패!!!!!!!큰일큰일@!!!!다시 입력해주세용~~")
					                     	location.href='${cp}/member/memberjoin';
					                     }
					                  }
					               });
...
<body>
	...
	<div class="container">
		<div class="col-md-6 col-md-offset-2 col-lg-8">
			<h1 align="center">JOIN</h1>&emsp;&emsp;
			...
			<div class="form-group">
				...
				<div class="col-lg-9" id="provision">
...
제 1 조 (목적)
이 약관은 petspital(이하 "사이트"라 합니다)에서 제공하는 인터넷서비스(이하 "서비스"라 합니다)의 이용 조건 및 절차에 관한 기본적인 사항을 규정함을 목적으로 합니다.
...
(시행일) 이 약관은 2015년 01월부터 시행합니다.
	...
	<input type="checkbox" name="agree" value="1" id="agree">개인정보 및 약관에 동의합니다.
<br><br>
			...
			<table class="table table-boardered">
				...
				<tr>
					...
					<td><input type="text" class="form-control" id="user_name"
						name="user_name" placeholder="Name" required></td>
					<td>
				...
				<tr>
					...
					<td><input type="text" class="form-control" id="user_id"
						name="user_id" placeholder="ID" required></td>
					<td><input type="button" id="idcbtn" value="중복확인" class ="btn btn-warning"></td>
				</tr>
				...
				<tr>
					...
					<td><input type="password" class="form-control" id="user_pw"
						name="user_pw" placeholder="PASSWORD" required></td>
					<td>
				...
				<tr>
					<th>비밀번호 확인</th>
					<td><input type="password" class="form-control" id="user_pw2"
						name="user_pw2" placeholder="Confirm Password" required></td>
					<td>
				...
				<tr>
					<th>휴대전화 ('-'를 포.함.한 번호를 입력해주세요)</th>
					<td><input type="text" class="form-control" id="user_phone"
						name="user_phone" placeholder="Phone Number" required></td>
					<td>
				...
				<tr>
					<th>주소</th>
					<td><input type="text" class="form-control" id="user_addr"
						name="user_addr" placeholder="Address" required></td>
					<td>
				...
				<tr>
					<td colspan="3" align="center">
						<a class="btn btn-danger px-3" href="${pageContext.request.contextPath}"> 
							<i class="joinbtn" aria-hidden="true"></i>취소하기 
						</a>&emsp;&emsp;
					<input type="button" class="btn btn-primary" value="회원가입" id="join">
					</td>
				</tr>
